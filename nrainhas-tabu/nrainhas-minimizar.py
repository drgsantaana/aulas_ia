...
def main():
    ...
    menor_conflito_encontrado = total_conflitos

    # Laço principal do algoritmo de busca tabu
    while total_conflitos != 0 and (total_execucoes == 0 or contador_execucoes < total_execucoes):
        ...
        if melhor_movimento:
            ...
            if total_conflitos < menor_conflito_encontrado:
                menor_conflito_encontrado = total_conflitos
    ...
    print(f"Menor número de conflitos encontrado: {menor_conflito_encontrado}")  # Exibe menor conflito
